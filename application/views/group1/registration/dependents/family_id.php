<div class="container">
    <div class="form-group row">
        <div class="col-lg-56 col-md-56 col-sm-56 col-xs-12">
            ...
            <input  type="number" name="family_id" id="family_id" class="form-control" placeholder="Enter your family ID"  <?php echo $registration_edit ? (isset($family_id)? 'value="'.$family_id.'" required': '') : '' ?> >
